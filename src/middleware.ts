...
const PUBLIC_ROUTES = ['/splash', '/login', '/signup', '/forgot-password', '/role-selection', '/auth', '/terms-of-service', '/privacy-policy', '/nearby', '/search', '/vendor-profile', '/profile', '/oauth-legal'];
